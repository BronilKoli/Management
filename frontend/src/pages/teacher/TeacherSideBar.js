    ...
    return (
        <>
            <React.Fragment>
                ...
                {/* <ListItemButton component={Link} to="/Teacher/add-attendance">
                    <ListItemIcon>
                        <AccountCircleOutlinedIcon color={location.pathname.startsWith("/Teacher/add-attendance") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
